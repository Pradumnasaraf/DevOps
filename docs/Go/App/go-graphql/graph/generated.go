...
type ComplexityRoot struct {
	...
	Mutation struct {
		AddVideo func(childComplexity int, input model.NewVideo) int
	}
...
type MutationResolver interface {
	AddVideo(ctx context.Context, input model.NewVideo) (*model.Video, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addVideo":
		...
		return e.complexity.Mutation.AddVideo(childComplexity, args["input"].(model.NewVideo)), true
...
func (ec *executionContext) field_Mutation_addVideo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNnewVideo2goᚑgrapgqlᚋgraphᚋmodelᚐNewVideo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_addVideo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddVideo(rctx, fc.Args["input"].(model.NewVideo))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNVideo2ᚖgoᚑgrapgqlᚋgraphᚋmodelᚐVideo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_videos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Video)
	fc.Result = res
	return ec.marshalNVideo2ᚕᚖgoᚑgrapgqlᚋgraphᚋmodelᚐVideoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Video_author(ctx context.Context, field graphql.CollectedField, obj *model.Video) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthor2ᚖgoᚑgrapgqlᚋgraphᚋmodelᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputnewVideo(ctx context.Context, obj interface{}) (model.NewVideo, error) {
	...
	fieldsInOrder := [...]string{"title", "url", "authorId"}
...
func (ec *executionContext) marshalNAuthor2ᚖgoᚑgrapgqlᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *model.Author) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNVideo2goᚑgrapgqlᚋgraphᚋmodelᚐVideo(ctx context.Context, sel ast.SelectionSet, v model.Video) graphql.Marshaler {
	return ec._Video(ctx, sel, &v)
}

func (ec *executionContext) marshalNVideo2ᚕᚖgoᚑgrapgqlᚋgraphᚋmodelᚐVideoᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Video) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNVideo2ᚖgoᚑgrapgqlᚋgraphᚋmodelᚐVideo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNVideo2ᚖgoᚑgrapgqlᚋgraphᚋmodelᚐVideo(ctx context.Context, sel ast.SelectionSet, v *model.Video) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNnewVideo2goᚑgrapgqlᚋgraphᚋmodelᚐNewVideo(ctx context.Context, v interface{}) (model.NewVideo, error) {
